...
> extends UpdatableStaticRouteOption {
  ...
  */
  ...
  onCatch?: (error: Error, errorInfo: Solid.ErrorInfo) => void
  ...
  links?: () => Array<Solid.JSX.IntrinsicElements['link']>
  scripts?: () => Array<Solid.JSX.IntrinsicElements['script']>
  headers?: (ctx: {
    loaderData: ResolveLoaderData<TLoaderFn>
...
> {
  ...
  addChildren<
    TNewChildren extends Record<string, AnyRoute> | ReadonlyArray<AnyRoute>,
  >(
...
export type SyncRouteComponent<TProps> =
  ...
  | Solid.LazyExoticComponent<(props: TProps) => ReactNode>
