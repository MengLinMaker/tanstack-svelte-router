...
export const Match = Solid.createMemo(function MatchImpl({
  matchId,
}: {
  matchId: string
}) {
        ...
        >
          <ResolvedNotFoundBoundary
            fallback={(error) => {
              ...
              return Solid.createComponent(routeNotFoundComponent, error as any)
            }}
          >
...
export const MatchInner = Solid.createMemo(function MatchInnerImpl({
  matchId,
}: {
  matchId: string
}): any {
...
export const Outlet = Solid.createMemo(function OutletImpl() {
  const router = useRouter()
  ...
  if (matchId === rootRouteId) {
    return (
      <Solid.Suspense fallback={pendingElement}>{nextMatch}</Solid.Suspense>
    )
  }
