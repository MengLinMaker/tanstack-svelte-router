...
describe('member simple', () => {
  test('default namespace import', () => {
    ...
    const expectedCode = `import Solid from "solid-js";Solid.Suspense;`
  ...
  test('irrelevant default namespace import', () => {
    ...
    const expectedCode = `import Solid from "solid-js";console.log;`
    const newCode = portReactToSolid(code)
    expect(newCode).toBe(expectedCode)
  })
  ...
  test('namespace import', () => {
    ...
    const expectedCode = `import * as Solid from "solid-js";Solid.Suspense;`
    const newCode = portReactToSolid(code)
    expect(newCode).toBe(expectedCode)
  })
  ...
  test('specifier import', () => {
    ...
    const expectedCode = `import { Suspense } from "solid-js";Suspense;`
    const newCode = portReactToSolid(code)
    expect(newCode).toBe(expectedCode)
  })
})
